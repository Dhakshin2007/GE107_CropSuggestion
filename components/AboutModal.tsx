...
import { X, Cpu, Cloud, Zap, Bot, BarChart, FileText, CircuitBoard } from 'lucide-react';
                        ...
                        <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-3">
                            <div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <FeatureItem icon={<FileText size={16} />} title="PDF Reports">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-gray-900 mb-4 border-b pb-2">Project Resources</h3>
                                 <a 
                                    href="https://wokwi.com/projects/445873669046472705" 
                                    target="_blank" 
                                    rel="noopener noreferrer"
                                    className="flex items-start gap-4 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 border border-gray-200 transition-colors"
                                >
                                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-green-100 text-green-600 flex items-center justify-center mt-1">
                                        <CircuitBoard size={16} />
                                    </div>
                                    <div>
                                        <h4 className="font-semibold text-gray-800">Live IoT Sensor Simulation</h4>
                                        <p className="text-sm text-gray-600">
                                            Interact with the virtual ESP32 sensor that powers this dashboard, live on Wokwi.
                                        </p>
                                    </div>
                                </a>
                            </div>
